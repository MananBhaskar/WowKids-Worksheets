        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 10 }}>
          <div style={{ maxWidth: '42rem' }}>
            ...
            <p style={{ fontSize: isMobile ? '1rem' : '1.25rem', color: '#6b7280', marginTop: '1rem' }}>
              Engaging English worksheets to build reading, writing, and language skills for first graders with fun activities and exercises.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: 'linear-gradient(180deg, #1e3a8a 0%, #4c1d95 50%, #1e3a8a 100%)', padding: isMobile ? '2rem 1rem' : '4rem 1.5rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#ffffff', textAlign: 'center', fontSize: isMobile ? '1rem' : '1.125rem', maxWidth: '80rem', margin: '0 auto 4rem', lineHeight: 1.7, padding: isMobile ? '0 1rem' : '0' }}>
            Our 1st grade English worksheets help students develop essential reading and writing skills. From phonics and spelling to grammar and comprehension, these activities make learning language arts engaging and effective. Each worksheet is designed to support literacy development at the first-grade level.
          </p>
