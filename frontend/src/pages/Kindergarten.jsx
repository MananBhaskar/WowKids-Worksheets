// pages/KindergartenPage.jsx - Tailwind CSS Version
  ...
  const worksheetCategories = [
    {
      ...
      color: 'bg-purple-600',
      image: '/images/kindergarten-reading.png',
      link: '/kindergarten/reading'
    },
    {
      id: 2,
      title: 'Writing Worksheets',
      color: 'bg-green-600',
      image: '/images/kindergarten-writing.png',
      link: '/kindergarten/writing'
    },
    {
      id: 3,
      title: 'Math Worksheets',
      color: 'bg-blue-600',
      image: '/images/kindergarten-math.png',
      link: '/kindergarten/math'
    },
    {
      id: 4,
      title: 'Science Worksheets',
      color: 'bg-orange-500',
      image: '/images/kindergarten-science.png',
      link: '/kindergarten/science'
    },
    {
      id: 5,
      title: 'Social Studies Worksheets',
      color: 'bg-red-500',
      image: '/images/kindergarten-social.png',
      link: '/kindergarten/social-studies'
    },
    {
      id: 6,
      title: 'Phonics Worksheets',
      color: 'bg-pink-500',
      image: '/images/kindergarten-phonics.png',
      link: '/kindergarten/phonics'
    }
  ];
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-gray-800 mb-8">
            <span className="text-red-500">F</span>ree Printable Kindergarten Worksheets
          </h1>
          <p className="text-base md:text-lg leading-relaxed text-gray-600 text-justify max-w-5xl mx-auto">
            Explore our comprehensive collection of kindergarten worksheets designed to make learning fun and engaging. These worksheets cover essential skills including reading, writing, math, science, and more. Perfect for kindergarten teachers and parents looking to support their child's educational journey with high-quality, printable resources.
          </p>
        </div>
      </section>
