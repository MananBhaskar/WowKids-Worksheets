...
const SecondGradeScience = () => {
  ...
  const scienceWorksheets = [
    ...
    },
    {
      ...
      url: '#properties-matter'
    },
    {
      id: 4,
      title: 'Energy & Heat',
      image: 'https://images.unsplash.com/photo-1473773508845-188df298d2d1?w=300&h=200&fit=crop',
    ...
    },
    {
      id: 5,
      title: 'Solar System',
      image: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=300&h=200&fit=crop',
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 10 }}>
          <div style={{ maxWidth: '42rem' }}>
            ...
            <p style={{ fontSize: isMobile ? '1rem' : '1.25rem', color: '#6b7280', marginTop: '1rem' }}>
              Explore deeper scientific concepts including ecosystems, matter, energy, space, and the adaptations of living things.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: 'linear-gradient(180deg, #1e3a8a 0%, #4c1d95 50%, #1e3a8a 100%)', padding: isMobile ? '2rem 1rem' : '4rem 1.5rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#ffffff', textAlign: 'center', fontSize: isMobile ? '1rem' : '1.125rem', maxWidth: '80rem', margin: '0 auto 4rem', lineHeight: 1.7, padding: isMobile ? '0 1rem' : '0' }}>
            Our 2nd grade science worksheets expand students' understanding of the natural world through more complex topics. From ecosystems and food chains to matter and energy, these activities promote scientific inquiry and critical thinking. Each worksheet is carefully designed to meet second-grade science standards.
          </p>
