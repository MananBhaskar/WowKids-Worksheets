// pages/Grade2Page.jsx - Tailwind CSS Version
  ...
  const worksheetCategories = [
    {
      ...
      color: 'bg-rose-600',
      image: '/images/grade2-reading.png',
      link: '/grade2/reading'
    },
    {
      id: 2,
      ...
      image: '/images/grade2-writing.png',
      link: '/grade2/writing'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      color: 'bg-lime-600',
      image: '/images/grade2-science.png',
      link: '/grade2/science'
    },
    {
      id: 5,
      ...
      color: 'bg-violet-600',
      image: '/images/grade2-vocabulary.png',
      link: '/grade2/vocabulary'
    },
    {
      id: 6,
      title: 'Critical Thinking',
      color: 'bg-amber-600',
      image: '/images/grade2-thinking.png',
      link: '/grade2/critical-thinking'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-200 px-6 md:px-10 py-5">
        <div className="max-w-7xl mx-auto flex items-center text-sm">
          ...
          <span className="text-gray-700">2nd Grade</span>
        </div>
      </div>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center text-gray-800 mb-8">
            <span className="text-red-500">F</span>ree Printable 2nd Grade Worksheets
          </h1>
          <p className="text-base md:text-lg leading-relaxed text-gray-600 text-justify max-w-5xl mx-auto">
            Access our complete library of 2nd grade worksheets covering all core subjects. These carefully crafted resources help second graders develop critical reading, writing, math, and science skills. Our worksheets are perfect for classroom instruction, homework assignments, and extra practice at home. Help your child excel with these engaging educational materials.
          </p>
        </div>
      </section>
